/**
 * Direct upload script for cleaning slots to Convex
 * Usage: node direct-upload.js
 */
...
async function uploadData() {
  ...
  try {
    ...
    console.log(`📊 Uploading ${data.cleaningSlots.length} cleaning slots...\n`);
    ...
    const response = await fetch(`${CONVEX_URL}/api/mutation`, {
      ...
      body: JSON.stringify({
        path: "uploadData:uploadCleaningSlots",
        args: { slots: data.cleaningSlots },
        format: "json"
      })
    });
